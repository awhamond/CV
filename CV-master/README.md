...
This CV is created using the **`R`** Package [`vitae`](https://github.com/mitchelloharawild/vitae) as adapted and made publicly available by Bryan Jenks (https://github.com/tallguyjenks/CV) 
